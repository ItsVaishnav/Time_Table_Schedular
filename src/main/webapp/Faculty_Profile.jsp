...
<body>
    ...
    <!-- Breadcrumb Header -->
    <div class="header">
        <a href="Admin.jsp" class="text-decoration-none">Home</a> / <span class="text-muted">Faculty Profile</span>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4 d-flex align-items-stretch">
            <div class="profile-card w-100">
                <div class="text-center">
                    ...
                    <h4 class="mb-1">Dr. Rupali Pawar</h4>
        ...
        <div class="col-md-8">
            ...
            <div class="profile-card mb-4">
                <h5><strong>Full Name:</strong> Dr. Rupali Pawar</h5>
                <h5><strong>Email:</strong> repali.Pawar@gmail.com</h5>
                <h5><strong>Mobile:</strong> 9850409350</h5>
