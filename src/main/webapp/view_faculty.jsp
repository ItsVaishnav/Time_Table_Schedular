...
<body>
	...
	<div class="main-body">
		<div class="flex-1 p-6">
			...
			<div>
               ...
               <div style="width: 90%; margin: 50px auto; padding: 20px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.15); font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    ...
    <div class="heading">Faculty Role Details</div>
    ...
    <table class="faculty-table">
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT * FROM userss WHERE role = 'faculty'";
